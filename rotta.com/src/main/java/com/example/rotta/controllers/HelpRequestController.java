...
public class HelpRequestController {
    ...
    @MessageMapping("/notify.accept")
    public void acceptHelp(@Payload AcceptRequestDTO req, Principal principal) {
        Integer helperId = Integer.valueOf(principal.getName());
        helpRequestService.acceptHelpRequest(req.helpRequestId(), helperId);
    }
}
